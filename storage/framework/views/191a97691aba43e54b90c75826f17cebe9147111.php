<?php $__env->startSection('content'); ?>
														...
														<div class=" table-responsive" id="printableTable">
                                                            <table id="orderTable" class="display" style="width:100%">
																...
																<tbody class="kt-table-tbody text-dark">
                                                                    <?php $__currentLoopData = $sessionms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 ...
 <!-- start Modal -->           
  <div class="modal fade" id="issue<?php echo e($session->id); ?>" tabindex="-1" session="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" session="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Edit <?php echo e($session->item); ?></h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            <form action="<?php echo e(route('sessionm.update',$session->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="session" class="form-control" value="<?php echo e($session->session_name); ?>">
                        ...
                        <select name="status" id="status" class="form-control">
                                        ...
                                        <option value="<?php echo e($session->status); ?>"><?php echo e($session->status); ?></option>
                ...
                <button type="submit" class="btn btn-success" >Update</button>
																			...
																			<div class="card-toolbar text-right">
																				...
																				<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdowneditButton2"  style="position: absolute; transform: translate3d(1001px, 111px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                                                    ...
                                                                                    <a href="javascript:void(0)" class="btn-success dropdown-item click-edit" id="click-edit1" data-toggle="modal" data-target="#issue<?php echo e($session->id); ?>">Edit</a>

                                                                                     <a href="<?php echo e(route('delete-sessionm',$session->id)); ?>" class="btn-success dropdown-item click-delete" id="click-edit1" onclick="return confirm(id='Are you sure you want to delete this  <?php echo e($session->sessionm_name); ?>')">Delete</a>
  ...
  <div class="card-body"  style="background-color:#b2ca5d !important">
		...
		<form id="myform" action="<?php echo e(route('sessionm.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
			<div class="row">
				<div class="col-12">
					<div class="form-group">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/drongosa/check.pasah.net/resources/views/admin/settings/sessions/sessionm.blade.php ENDPATH**/ ?>