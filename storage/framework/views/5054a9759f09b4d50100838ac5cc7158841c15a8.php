<?php $__env->startSection('content'); ?>
					...
					<div class="d-flex flex-column-fluid">
						...
						<div class="container-fluid">
							<div class="row">
                              ...
                              <?php $__currentLoopData = $qnsapplied; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																	<tr class="kt-table-row kt-table-row-level-0">
																			<td ><?php echo e($department->id); ?></td>
																		<!-- <td ><?php echo e($department->metaname_id); ?></td> -->
																		<td><?php echo e($department->metaname_name); ?></td>
 ...
 <!-- start Modal -->
  <div class="modal fade" id="issue<?php echo e($department->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="<?php echo e(route('qnsapplied-update',$department->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo e($department->qns); ?>
                    ...
                    <div class="form-group">
												...
												<select class="arabic-select w-100 mb-3 h-30px" name="metaname" >
														<option value="<?php echo e($department->department_id ?? 0); ?>" selected><?php echo e($department->metaname_name?? ""); ?></option>
                ...
                <button type="submit" class="btn btn-success" >Update</button>
																			...
																			<div class="card-toolbar text-right">
																				...
																				<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdowneditButton2"  style="position: absolute; transform: translate3d(1001px, 111px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                                                    ...
                                                                                    <a href="javascript:void(0)" class="btn-success dropdown-item click-edit" id="click-edit1" data-toggle="modal" data-target="#issue<?php echo e($department->id); ?>">Edit</a>

                                                                                     <!-- <a href="<?php echo e(route('delete-department',$department->id)); ?>" class="btn-success dropdown-item click-delete" id="click-edit1" onclick="return confirm(id='Are you sure you want to delete this  <?php echo e($department->department_name); ?>')">Delete</a> -->

                                                                             <!--    <form action="<?php echo e(route('delete-department',$department->id)); ?>" method="POST">
                                                                                    <?php echo csrf_field(); ?>
                                                                                    <input type="hidden" name="_method" value="delete">
																					<input type="submit" class="btn-primary dropdown-item" value="Delete" onclick="return confirm(id='Are you sure you want to delete this  <?php echo e($department->department_name); ?>')">
                                                                                </form> -->
																				</div>
																				</div>
																		</td>
...
<div class="row col-xl-12 col-md-12">
  <div class="card-body"  style="background-color:#b2ca5d !important">
		<form id="myform" action="<?php echo e(route('department.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
			<div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/drongosa/check.pasah.net/resources/views/admin/settings/qnsapplied/qnsapplied.blade.php ENDPATH**/ ?>