                ...
                <button type="submit" class="btn btn-success" >Update</button>
																			...
																			<div class="card-toolbar text-right">
                                                                                ...
                                                                                <?php if(($metaname->status)!="Stop"): ?>
                                                                                    ...
                                                                                    <a href="<?php echo e(route('update-metaname',$metaname->id)); ?>" class="btn-success dropdown-item click-delete" id="click-edit1" onclick="return confirm(id='Are you sure you want to Recovery this  <?php echo e($metaname->site_name); ?>')">Recovery</a>
                                                                                

                                                                                <form action="<?php echo e(route('metaname.destroy',$metaname->id)); ?>" method="POST">
                                                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\247security\resources\views/admin/settings/recovery/recoveryMetaname.blade.php ENDPATH**/ ?>