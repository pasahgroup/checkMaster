...
@section('content')
				...
				<td>
 <!-- start Modal -->
  <div class="modal fade" id="issue{{ $bank->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Edit: Account no: {{ $bank->account_no }}</h5>
                ...
                <div class="row">
                  ...
                  <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="country" class="form-control" value="{{ $bank->country }}">
                            <small  class="form-text text-muted">please edit country name</small>
                        </div>
                    

                       <div class="form-group">
                        <label class="text-dark">Account Name {{ $bank->account_name }}</label>
  ...
  {{-- end of modal --}}
                                    ...
                                    @if(($bank->status)!="Stop")
 <a href="javascript:void(0)" class="btn-success dropdown-item click-edit" id="click-edit1" data-toggle="modal" data-target="#issue{{ $bank->id }}">Edit</a>
 <!-- <a href="{{ route('edit-course',$bank->id) }}" class="btn-success dropdown-item click-delete" id="click-edit1">Edit2</a> -->
<a href="{{ route('delete-bank',$bank->id) }}" class="btn-success dropdown-item click-delete" id="click-edit1" onclick="return confirm(id='Are you sure you want to delete this  {{$bank->bank_name}}')">Delete</a>
	...
	<div  class="offcanvas offcanvas-right kt-color-panel p-5 kt_notes_panel">
		...
		<form id="myform" action="{{ route('bank.store') }}" method="POST">
            @csrf
			<div class="row">
				<div class="col-12">
