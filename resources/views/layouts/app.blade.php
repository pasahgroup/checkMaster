...
<body id="tc_body" class="header-fixed header-mobile-fixed subheader-enabled aside-enabled aside-fixed">
   <!-- Paste this code after body tag -->
	...
	<div class="d-flex flex-column flex-root"   style="background-color:#fff !important">
      ...
      <!--begin::Aside-->
  @role('Manager|Admin|GeneralManager|GeneralAdmin|SuperAdmin|Manager|User|Store|HouseKeeper|Maintenancier|MaintenanceReport')
                ...
                @role('SuperAdmin|GeneralAdmin|GeneralManager|Manager|Admin|HouseKeeping|Maintenancier')
								<div class="topbar-item" data-toggle="dropdown" data-display="static">
									<div class="btn btn-icon btn-clean btn-dropdown mr-1">
										...
										<span class="badge badge-pill badge-secondary">{{$qnsCount->count() ?? 0}}</span>
									</div>
								</div>
@endrole
