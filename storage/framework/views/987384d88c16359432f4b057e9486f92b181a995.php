...
<br>
 ...
 <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'GeneralAdmin|SuperAdmin|Admin')): ?>
            <li class="nav-item
            <?php echo e((request()->is('subcourse')) ? 'active' : ''); ?>

            <?php echo e((request()->is('course')) ? 'active' : ''); ?>

             <?php echo e((request()->is('titles')) ? 'active' : ''); ?>

              <?php echo e((request()->is('bank')) ? 'active' : ''); ?>
                ...
                <div class="collapse nav-collapse
                <?php echo e((request()->is('subcourse')) ? 'show' : ''); ?>

                <?php echo e((request()->is('course')) ? 'show' : ''); ?>

                 <?php echo e((request()->is('titles')) ? 'show' : ''); ?>

                <?php echo e((request()->is('bank')) ? 'show' : ''); ?>
                ...
                " id="course" data-parent="#accordiond">
                    <div id="accordiond">
                        <ul class="nav flex-column">                            
                              ...
                              <li class="nav-item <?php echo e((request()->is('course')) ? 'sub-active' : ''); ?>">
                                <a href="<?php echo e(route('course.index')); ?>" class="nav-link sub-nav-link <?php echo e((request()->is('course')) ? 'active' : ''); ?>">
                                    <span class="svg-icon nav-icon d-flex justify-content-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10px" height="10px" fill="currentColor" class="bi bi-circle" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                          </svg>
  ...
  <li class="nav-item <?php echo e((request()->is('titles')) ? 'sub-active' : ''); ?>">
                                <a href="<?php echo e(route('titles.index')); ?>" class="nav-link sub-nav-link <?php echo e((request()->is('titles')) ? 'active' : ''); ?>">
                                    <span class="svg-icon nav-icon d-flex justify-content-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10px" height="10px" fill="currentColor" class="bi bi-circle" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                          </svg>
                              ...
                              <li class="nav-item <?php echo e((request()->is('subcourse')) ? 'sub-active' : ''); ?>">
                                <a href="<?php echo e(route('subcourse.index')); ?>" class="nav-link sub-nav-link <?php echo e((request()->is('subcourse')) ? 'active' : ''); ?>">
                                    <span class="svg-icon nav-icon d-flex justify-content-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10px" height="10px" fill="currentColor" class="bi bi-circle" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                          </svg>
                               ...
                               <li class="nav-item <?php echo e((request()->is('gallary')) ? 'sub-active' : ''); ?>">
                                <a href="<?php echo e(route('gallary.index')); ?>" class="nav-link sub-nav-link <?php echo e((request()->is('gallary')) ? 'active' : ''); ?>">
                                    <span class="svg-icon nav-icon d-flex justify-content-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10px" height="10px" fill="currentColor" class="bi bi-circle" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                          </svg>
                              ...
                              <li class="nav-item <?php echo e((request()->is('bank')) ? 'sub-active' : ''); ?>">
                                <a href="<?php echo e(route('bank.index')); ?>" class="nav-link sub-nav-link <?php echo e((request()->is('bank')) ? 'active' : ''); ?>">
                                    <span class="svg-icon nav-icon d-flex justify-content-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10px" height="10px" fill="currentColor" class="bi bi-circle" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                          </svg>
...
<?php /**PATH C:\xampp\htdocs\247security\resources\views/layouts/nav.blade.php ENDPATH**/ ?>