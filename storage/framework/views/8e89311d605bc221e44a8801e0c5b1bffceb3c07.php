                            ...
                            <div >
                                <div class=" table-responsive" id="printableTable">
                                    ...
                                    <tbody class="kt-table-tbody text-dark">
                                        <?php $__currentLoopData = $reportWeeklyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $weeklyData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="kt-table-row kt-table-row-level-0">
                                            ...
                                            <td><?php echo e($weeklyData->answer); ?></td>
                                              <td <?php if($weeklyData->answer_classification ==='Bad'): ?> style="background-color:yellowGreen;"<?php endif; ?> <?php if($weeklyData->answer_classification ==='maintenance'): ?> style="background-color:maroon;"<?php endif; ?> <?php if($weeklyData->answer_classification ==='Good'): ?> style="background-color:green;"<?php endif; ?>><?php echo e($weeklyData->answer_classification); ?>:<?php if($weeklyData->answer_label !='no_value'): ?> (<?php echo e($weeklyData->answer_label); ?>) <?php endif; ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/hakunama/checklistmaster.hakunamatatas.net/resources/views/reports/weekly-report.blade.php ENDPATH**/ ?>