...
<body id="tc_body" class="header-fixed header-mobile-fixed subheader-enabled aside-enabled aside-fixed">
   <!-- Paste this code after body tag -->
	...
	<div class="d-flex flex-column flex-root"   style="background-color:#fff !important">
      ...
      <!--begin::Aside-->
  <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'Manager|Admin|GeneralManager|GeneralAdmin|SuperAdmin|User|Store|HouseKeeper|Maintenancier')): ?>
...
<?php /**PATH C:\xampp\htdocs\horesyff\resources\views/layouts/app.blade.php ENDPATH**/ ?>