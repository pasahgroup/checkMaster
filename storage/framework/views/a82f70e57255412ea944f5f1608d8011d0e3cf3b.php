...
<body id="tc_body" class="header-fixed header-mobile-fixed subheader-enabled aside-enabled aside-fixed">
   <!-- Paste this code after body tag -->
	...
	<div class="d-flex flex-column flex-root"   style="background-color:#fff !important">
      ...
      <!--begin::Aside-->
  <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'Manager|Admin|GeneralManager|GeneralAdmin|SuperAdmin|User|Store')): ?>
								...
								<div class="dropdown-menu p-0 m-0 dropdown-menu-right w-300px">
									<form>
                                        ...
                                        <div class="nav-hover scrollbar-1 ">
											...
											<a href="/managers-inspection/{id}" class="nav-item border-bottom">
												<div class="nav-link">
										...
										<div class="d-flex flex-column p-3 rounded-top">
											...
											<h4 class="d-flex justify-content-center mb-0  rounded-top">
												<a href="/managers-inspection/{id}" class="font-size-base text-primary">View All</a>
											</h4>
...
<?php /**PATH /home3/hakunama/checklistmaster.hakunamatatas.net/resources/views/layouts/app.blade.php ENDPATH**/ ?>