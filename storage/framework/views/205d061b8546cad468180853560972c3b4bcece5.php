						...
						<div class="container-fluid">
							<div class="row">
								<div class="col-12">
                                    ...
                                    <td><a href="#"><?php echo e($asset->id); ?></a></td>
                                      <td><a href="#"><?php echo e($asset->asset_name); ?></a></td>

																		<td><?php echo e($asset->asset_type); ?></td>
																		<td><?php echo e($asset->asset_brand); ?></td>
																		<td><?php echo e($asset->asset_location); ?></td>
																		<td><?php echo e($asset->asset_version); ?></td>
																	<td><?php echo e($asset->asset_serial_no); ?></td>
																		<td><?php echo e($asset->asset_barcode); ?></td>
                                    <td><?php echo e($asset->asset_tag_no); ?></td>
																		 <td><div class="logo mr-auto"><img src="<?php echo e(URL::asset('/storage/properties/'.$asset->photo)); ?>" width="60" height="40"></div></td>

																		<td><?php echo e($asset->asset_description); ?></td>
                                        <td><a href="#"><?php echo e($asset->property_name); ?></a></td>
												             <td><?php echo e(date('Y-M-d',strtotime($asset->created_at))); ?></td>
                                    <td><?php echo e($asset->status); ?></td>
																		<td>
 <!-- start Modal -->
  <div class="modal fade" id="issue<?php echo e($asset->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Edit: <?php echo e($asset->asset_name); ?></h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
           	<form id="myform" action="<?php echo e(route('update-asset',$asset->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
			<div class="row">
				...
				<div class="col-12">
					<div class="form-group">
						...
						<input type="text" name="asset_name" class="form-control" value="<?php echo e($asset->asset_name); ?>">
					...
					<div class="form-group">
				 	...
				 	<input type="text" name="asset_type" class="form-control" value="<?php echo e($asset->asset_type); ?>">
				 	<!-- <small  class="form-text text-muted">please enter Asset name</small> -->
				 </div>
					...
					<div class="form-group">
		 			 ...
		 			 <input type="text" name="asset_brand" class="form-control" value="<?php echo e($asset->asset_brand); ?>">
		 			 <!-- <small  class="form-text text-muted">please enter Asset name</small> -->
		 		 </div>

				 <div class="form-group">
					<label class="text-dark" >Asset Version </label>
					<input type="text" name="asset_version" class="form-control" value="<?php echo e($asset->asset_version); ?>">
					<!-- <small  class="form-text text-muted">please enter Asset name</small> -->
				</div>

				<div class="form-group">
				 <label class="text-dark" >Asset Serial No </label>
				 <input type="text" name="asset_serial_no" class="form-control" value="<?php echo e($asset->asset_serial_no); ?>">
				 <!-- <small  class="form-text text-muted">please enter Asset name</small> -->
			 </div>

				<div class="form-group">
				 <label class="text-dark" >Asset Barcode</label>
				 <input type="text" name="asset_barcode" class="form-control" value="<?php echo e($asset->asset_barcode); ?>">
				 <!-- <small  class="form-text text-muted">please enter Asset name</small> -->
				</div>

				<div class="form-group">
				 <label class="text-dark" >Asset Tag. No </label>
				 <input type="text" name="asset_tag_no" class="form-control" value="<?php echo e($asset->asset_tag_no); ?>">
				 <!-- <small  class="form-text text-muted">please enter Asset name</small> -->
			 </div>
                ...
                <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3" id="asset_description" name="asset_description"><?php echo e($asset->asset_description); ?></textarea>
                </div>
...
<?php echo e(URL::asset('/storage/properties/'.$asset->photo)); ?>
   ...
   <div class="form-group">
              ...
              <img src="<?php echo e(URL::asset('/storage/properties/'.$asset->photo)); ?>" onClick="triggerClick()" id="profileDisplay" width="100px">
            </span>
  </div>
...
<?php endif; ?>
																			...
																			<div class="card-toolbar text-right">
																				...
																				<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdowneditButton2"  style="position: absolute; transform: translate3d(1001px, 111px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                                                    ...
                                                                                    <a href="javascript:void(0)" class="dropdown-item click-edit" id="click-edit1" data-toggle="modal" data-target="#issue<?php echo e($asset->id); ?>">Edit</a>
                                                                                    <a href="<?php echo e(route('delete-asset',$asset->id)); ?>" class="btn-success dropdown-item click-delete" id="click-edit1" onclick="return confirm(id='Are you sure you want to delete this  <?php echo e($asset->asset_name); ?>')">Delete</a>
                                                                              <!--   <form action="<?php echo e(route('properties.destroy',$asset->id)); ?>" method="POST">
                                                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/hakunama/checklistmaster.hakunamatatas.net/resources/views/admin/settings/assets/assets.blade.php ENDPATH**/ ?>