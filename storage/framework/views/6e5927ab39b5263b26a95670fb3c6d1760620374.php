...
table, th, td {
 ...
 <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'Admin|GeneralAdmin|SuperAdmin')): ?>
                    ...
                    <div class="card card-custom gutter-b bg-white border-0" >
                        <div class="card-body">
                            <form method="GET" action="<?php echo e(route('report-action',$property->id)); ?>" <?php if($prnt=="1"): ?> target="_blank" <?php endif; ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/drongosa/check.pasah.net/resources/views/admin/settings/action/report-action.blade.php ENDPATH**/ ?>