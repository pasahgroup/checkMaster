...
$url="http://check.pasah.net:8000/report-general/{$property->id}/dashboard";
//dd($url);
...
//dd(include_once(app_path().'/jrf/sample/setting.php'));
//dd($PHPJasperXML);

//$PHPJasperXML->transferDBtoArray($server,$user,$pass,$db);
$PHPJasperXML->transferDBtoArray('localhost','drongosa_checklistmaster_user','checklistmaster','drongosa_checklistmasterdb');
   // dd('ddd');
   // dd($PHPJasperXML);
    //dd('klopo print');
