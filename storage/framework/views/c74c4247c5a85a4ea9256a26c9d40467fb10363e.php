...
<?php $__env->startSection('content'); ?>
				...
				<td ><?php echo e($subcourse->id); ?></td>
				<td><?php echo e($subcourse->course_name); ?></td>
				<td><?php echo e($subcourse->title_name); ?></td>
					<td><?php echo e($subcourse->subcourse_name); ?></td>
					<td><?php echo e($subcourse->subcourse_description); ?></td>
					<td><?php echo e($subcourse->subcourse_cost); ?></td>

					<td><?php echo e($subcourse->subcourse_duration); ?></td>
					<td><?php echo e($subcourse->unit); ?></td>
					<td><div class="logo mr-auto"><img src="<?php echo e(URL::asset('/storage/subcourse/'.$subcourse->photo)); ?>" width="60" height="40"></div></td>
					<td><?php echo e($subcourse->status); ?></td>

				<td>
 <!-- start Modal -->
  <div class="modal fade" id="issue<?php echo e($subcourse->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Edit <?php echo e($subcourse->subcourse_name); ?></h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            <form action="<?php echo e(route('subcourse.update',$subcourse->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <label class="text-dark">Course Name <?php echo e($subcourse->id); ?></label>
                         <select name="course_id" id="course_id" class="form-control">
                                                                <option value="<?php echo e($subcourse->course_id); ?>" selected><?php echo e($subcourse->course_name); ?></option>
                 ...
                 <div class="form-group">
                        <label class="text-dark">Title Name</label>
                         <select name="title_name" id="title_name" class="form-control">
                                                                <option selected><?php echo e($subcourse->title_name); ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="subcourse_name" class="form-control" value="<?php echo e($subcourse->subcourse_name); ?>">
                            <small  class="form-text text-muted">please edit subcourse</small>
                        </div>
                       <div class="form-group">
                        <label class="text-dark">Description</label>
                        <textarea class="form-control" rows="3" id="subcourse_description" name="subcourse_description"><?php echo e($subcourse->subcourse_description); ?></textarea>
                  </div>

                       <div class="form-group">
                        <label class="text-dark">Course Cost</label>
                        <input type="number" name="subcourse_cost" class="form-control" value="<?php echo e($subcourse->subcourse_cost); ?>">
                  </div>
                        ...
                        <input type="number" name="subcourse_duration" class="form-control" value="<?php echo e($subcourse->subcourse_duration); ?>">
                    </div>
                     	<div class="col-4">
                     		<label class="text-dark">Duration type</label>
                         <select name="unit" id="unit" class="form-control">
                                                                 <option value="<?php echo e($subcourse->unit); ?>" selected><?php echo e($subcourse->unit); ?> </option>
                                                                <option>Days</option>
                                                                <option>Week</option>
                                                                 <option>Month</option>
                                                                <option>Year</option>
                        ...
                        <div class="form-group">
                            <div class="row">
                          	<div class="col-3">
                 <div class="logo mr-auto"><img src="<?php echo e(URL::asset('/storage/subcourse/'.$subcourse->photo)); ?>" width="120" height="100"></div>
                     </div>
                     	<div class="col-7"> 
                     ...
                     <div class="form-group">
                        <label class="text-dark">Status</label>
                         <select name="status" id="status" class="form-control">
                                                            <option value="<?php echo e($subcourse->status); ?>" selected><?php echo e($subcourse->status); ?> </option>
                ...
                <button type="submit" class="btn btn-success" >Update</button>
                                    ...
                                    <?php if(($subcourse->status)!="Stop"): ?>
 <a href="javascript:void(0)" class="btn-success dropdown-item click-edit" id="click-edit1" data-toggle="modal" data-target="#issue<?php echo e($subcourse->id); ?>">Edit</a>
 <!-- <a href="<?php echo e(route('edit-course',$subcourse->id)); ?>" class="btn-success dropdown-item click-delete" id="click-edit1">Edit2</a> -->
<a href="<?php echo e(route('delete-subcourse',$subcourse->id)); ?>" class="btn-success dropdown-item click-delete" id="click-edit1" onclick="return confirm(id='Are you sure you want to delete this  <?php echo e($subcourse->course_name); ?>')">Delete</a>
	...
	<div  class="offcanvas offcanvas-right kt-color-panel p-5 kt_notes_panel">
		...
		<form id="myform" action="<?php echo e(route('subcourse.store')); ?>" method="POST" enctype="multipart/form-data">
                           <?php echo csrf_field(); ?>
			<div class="row">
				<div class="col-12">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\247security\resources\views/admin/settings/courses/subcourse.blade.php ENDPATH**/ ?>