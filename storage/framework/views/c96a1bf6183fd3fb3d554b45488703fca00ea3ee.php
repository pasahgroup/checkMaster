<?php $__env->startSection('content'); ?>
 ...
 <!-- start Modal -->           
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="<?php echo e(route('role-register.update',$role->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <button type="submit" class="btn btn-success" >Update</button>
																			...
																			<div class="card-toolbar text-right">
																				...
																				<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdowneditButton2"  style="position: absolute; transform: translate3d(1001px, 111px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                                                    ...
                                                                                    <a href="javascript:void(0)" class="btn-success dropdown-item click-edit" id="click-edit1" data-toggle="modal" data-target="#issue<?php echo e($role->id); ?>">Edit</a>

                                                                                     <a href="<?php echo e(route('delete-role',$role->id)); ?>" class="btn-success dropdown-item click-delete" id="click-edit1" onclick="return confirm(id='Are you sure you want to delete this  <?php echo e($role->name); ?>')">Delete</a>
  ...
  <div class="card-body"  style="background-color:#b2ca5d !important">
		...
		<form id="myform" action="<?php echo e(route('role-register.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
			<div class="row">
				<div class="col-12">
					<div class="form-group">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/hakunama/checklistmaster.hakunamatatas.net/resources/views/admin/settings/roles/roles.blade.php ENDPATH**/ ?>