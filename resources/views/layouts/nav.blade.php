    ...
    " id="Report"  data-parent="#accordion">
        <ul class="nav flex-column">
            ...
            <li class="nav-item {{ (request()->is('report-general/{id}/dashboard')) ? 'sub-active' : '' }}{{ (request()->is('filter-report-general/{id}/dashboard')) ? 'sub-active' : '' }}">
                ...
                <a href="/report-general/1/dashboard" class="nav-link sub-nav-link {{ (request()->is('report-general/{id}/dashboard')) ? 'active' : '' }} {{ (request()->is('filter-report-general/{id}/dashboard')) ? 'active' : '' }} ">
                    <span class="svg-icon nav-icon d-flex justify-content-center">
