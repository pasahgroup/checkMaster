...
@section('content')  
  ...
  @foreach ($subcourses as $subcourse)
                  <div class="item">
                            <img src="{{ URL::asset('/storage/subcourse/'.$subcourse->photo) }}" style="min-height: 20vh !important;max-height: 54vh;background-size: cover;width: 100%;" alt="Second slide">
                            <!-- Static Header -->
                            <div class="header-text hidden-xs">
                                <div class="col-md-12 text-center">
                                    <strong>{{$subcourse->title_name}}</strong>
                                    <br>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                    <br>
                                </div>
            ...
            <div class="col-sm-4">
                ...
                <div class="content">{{$course->id}}:<a href="#">{{$course->course_name}}</a></div>
