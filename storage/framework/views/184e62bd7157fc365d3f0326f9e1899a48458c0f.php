            ...
            <div class="row container-fluid">
                ...
                <div class="col-xl-6 col-md-6">
                  <h5 class="title font-weight-bold text-center">Users List</h5>                    <div class="card card-custom gutter-b bg-white border-0">
                   <div class="card-body">
                       <form  method="post"  action="<?php echo e(route('user-activity.store')); ?>" enctype="multipart/form-data">
                             <?php echo csrf_field(); ?>
...
<div class="form-group">
     ...
     <?php if(isset($activities)): ?>
      ...
      <div class="row">
      <div class="col-xl-8 col-md-8 col-xs-8"><?php echo e($activity->metaname_name); ?></div>
     <div class="col-xl-4 col-md-4 col-xs-4"><input type="checkbox" name="activities[]" value="<?php echo e($activity->id); ?>">
     </div>
   </div>
   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
   <?php endif; ?>
...
<?php /**PATH /home/drongosa/check.pasah.net/resources/views/livewire/user-activity.blade.php ENDPATH**/ ?>