...
<label class="text-dark" ><b>Manager Inspection:<i style="color:#f6f7f4">(Metaname : <?php echo e($metaAll); ?>)</i></b>
<!-- <p id="demo"></p> -->
  <script>
...
<span  <?php if($qn->answer_label =="no_value"): ?>
 ...
 >
  ...
  Answer: <?php echo e($qn->answer); ?>(<?php echo e($qn->answer_label); ?>):<?php echo e($qn->opt_answer_id); ?>   |    Proposed answer:
  <select name="idx<?php echo e($p->id); ?>_<?php echo e($qn->id); ?>_<?php echo e($meta->id); ?>_<?php echo e($qn->opt_answer_id); ?>_<?php echo e($p->id); ?>_<?php echo e($section->id); ?>[]" id="indicator_id"  onclick="setQnFunction(<?php echo e($p->id); ?>,<?php echo e($qn->id); ?>)" onkeyup="setQnFunction(<?php echo e($p->id); ?>,<?php echo e($qn->id); ?>)" class="form-control">
  ...
  <textarea rows="4" cols="40" id="desc" name="desc<?php echo e($p->id); ?>_<?php echo e($qn->id); ?>_<?php echo e($meta->id); ?>_<?php echo e($qn->opt_answer_id); ?>_<?php echo e($p->id); ?>_<?php echo e($section->id); ?>[]" placeholder="---enter description if any---" class="form-control" style="white-space: normal;overflow:hidden" maxlength="680">
...
<br/>
<input type="file" name="attachment<?php echo e($p->id); ?>_<?php echo e($qn->id); ?>_<?php echo e($meta->id); ?>_<?php echo e($qn->opt_answer_id); ?>_<?php echo e($p->id); ?>_<?php echo e($section->id); ?>[]" accept="image/*" capture="camera">
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.button','data' => ['class' => 'btn-sm btn btn-secondary float-right','name' => 'email_send','value' => 'email_send']]); ?>
<?php $component->withName('jet-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['class' => 'btn-sm btn btn-secondary float-right','name' => 'email_send','value' => 'email_send']); ?>
...
//alert(status);
 ...
 $('#'+status+'').val(200);
    ...
    $.ajax({
       type:'POST',
       dataType:'json',
       url:"<?php echo e(route('checklistx.store')); ?>", // add your earlier created route here
...
<?php /**PATH /home3/hakunama/checklistmaster.hakunamatatas.net/resources/views/livewire/managerlist.blade.php ENDPATH**/ ?>