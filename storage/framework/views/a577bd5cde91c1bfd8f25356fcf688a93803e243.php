                            ...
                            <table id="orderTable" class="display" style="width:100%">
                              ...
                              <?php $__currentLoopData = $metadatas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metadata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																	<tr class="kt-table-row kt-table-row-level-0">
																		<td ><?php echo e($metadata->id); ?></td>
																		<td><?php echo e($metadata->metadata_name); ?></td>
																		<td><?php echo e($metadata->datatype); ?></td>

																		<td>

 <!-- start Modal -->
  <div class="modal fade" id="issue<?php echo e($metadata->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Edit <?php echo e($metadata->item); ?></h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            <form action="<?php echo e(route('metadata.update',$metadata->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="metadata_name" class="form-control" value="<?php echo e($metadata->metadata_name); ?>">
                        ...
                        <select name="datatype" id="" class="form-control">
                                        ...
                                        <option><?php echo e($metadata->datatype); ?></option>
                                         <?php $__currentLoopData = $datatypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datatype): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <option value="<?php echo e($datatype->datatype); ?>"><?php echo e($datatype->datatype_name); ?></option>
                ...
                <button type="submit" class="btn btn-success" >Update</button>
																			...
																			<div class="card-toolbar text-right">
                                                                                ...
                                                                                <?php if(($metadata->status)!="Stop"): ?>
                                                                                    <a href="javascript:void(0)" class="btn-success dropdown-item click-edit" id="click-edit1" data-toggle="modal" data-target="#issue<?php echo e($metadata->id); ?>">Edit</a>

                                                                                     <a href="<?php echo e(route('delete-metadata',$metadata->id)); ?>" class="btn-success dropdown-item click-delete" id="click-edit1" onclick="return confirm(id='Are you sure you want to delete this  <?php echo e($metadata->metadata_name); ?>')">Delete</a>
	...
	<div  class="offcanvas offcanvas-right kt-color-panel p-5 kt_notes_panel">
		...
		<form id="myform" action="<?php echo e(route('metadata.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
			<div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/drongosa/check.pasah.net/resources/views/admin/settings/metadata/metadata.blade.php ENDPATH**/ ?>