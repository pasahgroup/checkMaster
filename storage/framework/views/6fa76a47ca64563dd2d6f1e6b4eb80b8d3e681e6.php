...
<div class="row">
  ...
  <div class="form-group">
            ...
            <div class="form-group">
                     ...
                     <!-- <input type="text" wire.model="assetID" name="assetID" id="assetID" value="<?php echo e($selectedOption); ?>"> -->
  </div>
  </div>
 ...
 <input type="hidden" wire.model="assetID" name="assetID" id="assetID" value="<?php echo e($selectedOption); ?>">
              ...
              <?php endif; ?>
               ...
               <?php if($checkq->answer_label !="no_value"): ?>
                ...
                <div id="popup<?php echo e($metaname_id); ?>_<?php echo e($qn->id); ?>_<?php echo e($metaname_id); ?>_<?php echo e($section->section); ?>" style="display:none;">
                 ...
                 <option style="background-color:#fc6c85" value="Non Critical">Non Critical</option>
                 <option style="background-color:red" value="Critical">Critical</option>
                  </select>
...
<?php endif; ?>
      ...
      <textarea rows="4" cols="40" id="desc" name="desc<?php echo e($metaname_id); ?>_<?php echo e($qn->id); ?>_<?php echo e($metaname_id); ?>_<?php echo e($section->section); ?>[]" placeholder="---enter description if any---" class="form-control" style="white-space: normal;overflow:hidden" maxlength="680">
          <?php $__currentLoopData = $checkQns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $checkq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /home3/hakunama/test.hakunamatatas.net/resources/views/livewire/checklist.blade.php ENDPATH**/ ?>