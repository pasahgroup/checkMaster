...
<div class="subheader py-2 py-lg-6 subheader-solid">
    ...
    <form  method="post"  action="<?php echo e(route('activity-roles.store')); ?>" enctype="multipart/form-data">
                             <?php echo csrf_field(); ?>
...
<div class="form-group">
     ...
     <?php if(isset($activities)): ?>
      ...
      <div class="row">
      <div class="col-xl-9 col-md-9"><?php echo e($activity->metaname_name); ?></div>
     <div class="col-xl-3 col-md-3"><input type="checkbox" name="activities[]" value="<?php echo e($activity->id); ?>"></div>
   </div>
   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
   <?php endif; ?>
</div>
...
<?php /**PATH /home/drongosa/check.pasah.net/resources/views/livewire/activity-roles.blade.php ENDPATH**/ ?>