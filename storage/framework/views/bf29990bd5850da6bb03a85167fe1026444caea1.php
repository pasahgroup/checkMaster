              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-white mb-0 px-0 py-2">
                  <li class="breadcrumb-item active" aria-current="page">Roles & Permission</li>
                    <li class="breadcrumb-item active" aria-current="page">Assign Roles to User:(ARoU)</li>
                </ol>
              </nav>
            </div>
          </div>
            ...
            <div class="row container-fluid">
                ...
                <div class="col-xl-6 col-md-6">
                  <h5 class="title font-weight-bold text-center">Users List</h5>                    <div class="card card-custom gutter-b bg-white border-0">
                   <div class="card-body">
                       <form  method="post"  action="<?php echo e(route('assign-roles-user.store')); ?>" enctype="multipart/form-data">
                             <?php echo csrf_field(); ?>
...
<div class="form-group">
    <?php if(isset($users)): ?>
      ...
      <div class="row">
      <div class="col-xl-9 col-md-9"><?php echo e($user->name); ?></div>
     <div class="col-xl-3 col-md-3"><input type="checkbox" name="users[]" value="<?php echo e($user->id); ?>"></div>
   </div>
...
<div class="form-group">
     ...
     <?php if(isset($roles)): ?>
      ...
      <div class="row">
      <div class="col-xl-8 col-md-8 col-xs-8"><?php echo e($role->name); ?></div>
     <div class="col-xl-4 col-md-4 col-xs-4"><input type="checkbox" name="roles[]" value="<?php echo e($role->id); ?>">
     </div>
   </div>
   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
   <?php endif; ?>
...
<?php /**PATH /home/drongosa/check.pasah.net/resources/views/livewire/user-roles.blade.php ENDPATH**/ ?>