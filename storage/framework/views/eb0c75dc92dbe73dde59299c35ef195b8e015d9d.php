    ...
    <div class="modal-dialog" role="document">
				...
				<div class="col-12">
                    ...
                    <div class="form-group">
                        ...
                        <select name="property_category" id="" class="form-control">
                          <option><?php echo e($property->property_name); ?></option>
                                        <option>Hotel</option>
                                          <option>Lodge</option>
 	...
 	<div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <input type="mail" name="email" class="form-control" name="email" value="<?php echo e($property->email); ?>">
                        </div>
			...
			<button type="submit" class="btn btn-primary">Update</button>
																			...
																			<div class="card-toolbar text-right">
																				...
																				<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdowneditButton2"  style="position: absolute; transform: translate3d(1001px, 111px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                                                    ...
                                                                                    <a href="<?php echo e(route('update-property',$property->id)); ?>" class="btn-success dropdown-item click-delete" id="click-edit1" onclick="return confirm(id='Are you sure you want to Recovery this  <?php echo e($property->property_name); ?>')">Recovery</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\horesyff\resources\views/admin/settings/recovery/recoveryProperty.blade.php ENDPATH**/ ?>