                                  ...
                                  <div class="card">
                                      <div class="card-header">
                                          <div class="card-head-row">
                                              <div class="card-title text-center">{{ __($user->name) }}</div>
                                              ...
                                              <div class="comment-phara">
                                                  <div class="comment-adminpr" align="center">
                                                      <a id="selectPic" href="javascript:void(0)"  >
                                                          ...
                                                          @else
                                                           <img src="{{URL::asset('/storage/profile/'.$user->img) }}" alt="No photo" style="height: 20vh !important;width:70%">
                                                      @endif
                                                      </a>

                                                      <form id="form_profilepic" action="{{ route('image.upload.post') }}" method="post" enctype="multipart/form-data">
<!-- @csrf -->
                                                          <input type="hidden" name="_token" value="{{csrf_token()}}">
                                                          <input type="file" name="image" id="image" class="display_not">
                                                        <!-- </button class="collcc btn-info">{{ __('Update Profile') }}</button> -->
                                                          <!-- <button  class="collcc btn-info">{{ __('Update Profile') }}</button> -->
                                                      </form>
                                                  </div>
                                                  <br>
