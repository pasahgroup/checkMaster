...
<?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'SuperAdmin|GeneralAdmin|GeneralManager|Manager|Admin|Maintenancier')): ?>
  <li class="nav-item
            <?php echo e((request()->is('checklist/{id}')) ? 'active' : ''); ?>

            <?php echo e((request()->is('managers-inspection/{id}')) ? 'active' : ''); ?>

              <?php echo e((request()->is('dashboard-checklist/{id}')) ? 'active' : ''); ?>
            ...
            ">
                ...
                <div class="collapse nav-collapse
                <?php echo e((request()->is('checklist/{id}')) ? 'show' : ''); ?>

                  <?php echo e((request()->is('managers-inspection/{id}')) ? 'show' : ''); ?>

                    <?php echo e((request()->is('dashboard-checklist/{id}')) ? 'show' : ''); ?>
                ...
                " id="accordionChecklist" data-parent="#accordion">
                    ...
                    <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'SuperAdmin|GeneralAdmin|GeneralManager|Admin|HouseKeeping')): ?>
                               <li class="nav-item <?php echo e((request()->is('checklist/{id}')) ? 'sub-active' : ''); ?>">
                                <a href="/checklist/{id}" class="nav-link sub-nav-link <?php echo e((request()->is('checklist/{id}')) ? 'active' : ''); ?>">
                                    <span class="svg-icon nav-icon d-flex justify-content-center">
                                        <svg xmlns="" width="10px" height="10px" fill="currentColor" class="bi bi-circle" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                          </svg>
...
">
    ...
    " id="Report"  data-parent="#accordion">
        <ul class="nav flex-column">
            ...
            <li class="nav-item <?php echo e((request()->is('dashboard-checklist/{id}')) ? 'sub-active' : ''); ?><?php echo e((request()->is('filter-admin')) ? 'sub-active' : ''); ?>">
                <a href="/dashboard-checklist/{id}" class="nav-link sub-nav-link <?php echo e((request()->is('dashboard-checklist/{id}')) ? 'active' : ''); ?> <?php echo e((request()->is('filter-admin')) ? 'active' : ''); ?> ">
                    <span class="svg-icon nav-icon d-flex justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10px" height="10px" fill="currentColor" class="bi bi-circle" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                          </svg>
...
<?php /**PATH /home3/hakunama/checklistmaster.hakunamatatas.net/resources/views/layouts/nav.blade.php ENDPATH**/ ?>