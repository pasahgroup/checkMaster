                                    ...
                                    <tbody class="kt-table-tbody text-dark">
                                        ...
                                        <tr class="kt-table-row kt-table-row-level-0">
                                            ...
                                            <td><?php echo e($monthlyData->answer); ?></td>
                                                <td <?php if($monthlyData->answer_classification ==='Bad'): ?> style="background-color:yellowGreen;"<?php endif; ?> <?php if($monthlyData->answer_classification ==='maintenance'): ?> style="background-color:maroon;"<?php endif; ?> <?php if($monthlyData->answer_classification ==='Good'): ?> style="background-color:green;"<?php endif; ?>><?php echo e($monthlyData->answer_classification); ?>:<?php if($monthlyData->answer_label !='no_value'): ?> (<?php echo e($monthlyData->answer_label); ?>) <?php endif; ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/drongosa/check.pasah.net/resources/views/reports/monthly-report.blade.php ENDPATH**/ ?>