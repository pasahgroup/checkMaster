                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="qn_name" class="form-control" value="<?php echo e($riq->qns); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\horesyff\resources\views/admin/settings/riq/riq-datatype.blade.php ENDPATH**/ ?>